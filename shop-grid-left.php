                ...
                <div class="row flex-row-reverse">
                        ...
                        <div class="pagination-area mt-15 mb-sm-5 mb-lg-0">
                            <nav aria-label="Page navigation example">
                                <ul class="pagination justify-content-start">
                                    ...
                                    <li class="page-item"><a class="page-link" href="#"><i class="fi-rs-angle-double-small-left"></i></a></li>
                                </ul>
                            </nav>
                        </div>
                    </div>
                    <div class="col-lg-3 primary-sidebar sticky-sidebar">
                        <div class="widget-category mb-30">
                            ...
                            <ul class="categories">
                                <li><a href="shop-fullwidth.php">Shoes & Bags</a></li>
                                <li><a href="shop-fullwidth.php">Blouses & Shirts</a></li>
                                <li><a href="shop-fullwidth.php">Dresses</a></li>
                                <li><a href="shop-fullwidth.php">Swimwear</a></li>
                                <li><a href="shop-fullwidth.php">Beauty</a></li>
                                <li><a href="shop-fullwidth.php">Jewelry & Watch</a></li>
                        ...
                        <div class="banner-img wow fadeIn mb-45 animated d-lg-block d-none">
                            ...
                            <div class="banner-text">
                                ...
                                <a href="shop-fullwidth.php">Shop Now <i class="fi-rs-arrow-left"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
