      ...
      <div class="row">
        ...
        <div class="col-lg-2 col-md-3">
          ...
          <ul class="footer-list wow fadeIn animated">
            ...
            <li><a href="page-404.php">Track My Order</a></li>
            <li><a href="page-purchase-guide.php">Help</a></li>
            <li><a href="shop-cart.php">Order</a></li>
          </ul>
        </div>
        <div class="col-lg-4">
