                ...
                <div class="col-xl-6 col-lg-4">
                    <div class="text-center">
                        <div id="news-flash" class="d-inline-block">
                            <ul>
                                <li>Get great devices up to 50% off <a href="shop-grid-left.php">View details</a></li>
                                <li>Supper Value Deals - Save more with coupons</li>
                                <li>Trendy 25silver jewelry, save up 35% off today <a href="shop-grid-left.php">Shop now</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="header-action-icon-2">
                            ...
                            <div class="cart-dropdown-wrap cart-dropdown-hm2">
                                <ul>
                                    ...
                                    <li>
                                        <div class="shopping-cart-img">
                                            <a href="shop-product-right.php"><img alt="Evara" src="assets/imgs/shop/thumbnail-1.jpg"></a>
                                        </div>
                                        <div class="shopping-cart-title">
