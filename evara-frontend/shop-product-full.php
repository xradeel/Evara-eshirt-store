...
<!-- Mirrored from wp.alithemes.com/html/evara/evara-frontend/shop-product-full.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 13 Mar 2024 18:20:57 GMT -->
        ...
        <div class="mobile-header-wrapper-inner">
            ...
            <div class="mobile-header-content-area">
                ...
                <div class="mobile-menu-wrap mobile-header-border">
                    ...
                    <?php require("components/header-mobile.php") ?>
                    <!-- mobile menu end -->
                </div>
