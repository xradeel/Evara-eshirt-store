...
<!-- Mirrored from wp.alithemes.com/html/evara/evara-frontend/blog-post-right.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 13 Mar 2024 18:21:28 GMT -->
                            ...
                            <li class="menu-item-has-children"><span class="menu-expand"></span><a href="shop-grid-right.html">shop</a>
                                <ul class="dropdown">
                                    ...
                                    <li class="menu-item-has-children"><span class="menu-expand"></span><a href="#">Single Product</a>
                                        <ul class="dropdown">
                                            <li><a href="shop-grid-left.php">Product – Right Sidebar</a></li>
                            ...
                            <li class="menu-item-has-children"><span class="menu-expand"></span><a href="#">Mega menu</a>
                                <ul class="dropdown">
                                    <li class="menu-item-has-children"><span class="menu-expand"></span><a href="#">Women's Fashion</a>
                                        <ul class="dropdown">
                                            <li><a href="shop-grid-left.php">Dresses</a></li>
                                            <li><a href="shop-grid-left.php">Blouses & Shirts</a></li>
                                            <li><a href="shop-grid-left.php">Hoodies & Sweatshirts</a></li>
                                            <li><a href="shop-grid-left.php">Women's Sets</a></li>
                                        </ul>
                                    </li>
                                    <li class="menu-item-has-children"><span class="menu-expand"></span><a href="#">Men's Fashion</a>
                                        <ul class="dropdown">
                                            <li><a href="shop-grid-left.php">Jackets</a></li>
                                            <li><a href="shop-grid-left.php">Casual Faux Leather</a></li>
                                            <li><a href="shop-grid-left.php">Genuine Leather</a></li>
                                        </ul>
                                    </li>
                                    <li class="menu-item-has-children"><span class="menu-expand"></span><a href="#">Technology</a>
                                        <ul class="dropdown">
                                            <li><a href="shop-grid-left.php">Gaming Laptops</a></li>
                                            <li><a href="shop-grid-left.php">Ultraslim Laptops</a></li>
                                            <li><a href="shop-grid-left.php">Tablets</a></li>
                                            <li><a href="shop-grid-left.php">Laptop Accessories</a></li>
                                            <li><a href="shop-grid-left.php">Tablet Accessories</a></li>
                                        </ul>
                                    </li>
                                </ul>
                            </li>
